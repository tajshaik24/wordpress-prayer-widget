...
class MPSTI_cWebClassado {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'classes/class-code-custom-feilds.php';
                ...
                require_once plugin_dir_path( dirname( __FILE__ ) ) . 'classes/class-plugin-custom-posttypes.php';
		 ...
		 */
               ...
               // require_once plugin_dir_path( dirname( __FILE__ ) ) . 'classes/shipping_method.php';
                
//                require_once plugin_dir_path( dirname( __FILE__ ) ) . 'classes/cweb_breadcrumb.php';
                
		$this->loader = new masjidi_namespace\MPSTI_cWeb_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new masjidi_namespace\MPSTI_cWeb_i18n();
	...
	private function define_admin_hooks() {
		$plugin_admin = new masjidi_namespace\MPSTI_cWeb_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new masjidi_namespace\MPSTI_cWeb_Public( $this->get_plugin_name(), $this->get_version() );
