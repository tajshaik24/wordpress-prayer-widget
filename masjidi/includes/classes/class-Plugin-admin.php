	 ...
	 */
	   ...
	   public function enqueue_scripts() {
        ...
        function register_my_custom_menu_page() {
          ...
          add_menu_page(__($cwebPluginName,$PluginTextDomain),__('Masjidi',$PluginTextDomain), 'read', 'masjidi_settings', array(&$this, 'my_custom_masjidi'));
         ...
         // add_submenu_page($cwebPluginName, __('masjidi',$PluginTextDomain), __('masjidi',$PluginTextDomain), 'read', 'masjidi', array(&$this, 'my_custom_masjidi'));
...
function my_custom_masjidi() {
	
            global $PluginTextDomain;
            if (!current_user_can('read')) {
                wp_die('You do not have sufficient permissions to access this page.',esc_html($PluginTextDomain));
            } else {
                include(CWEB_MASJIDI_PATH . 'admin/admin_page/masjidi_details.php');
            }
        }
